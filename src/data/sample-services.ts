  ...
  auto_repair: [
    {
      ...
      price: 70,
      options: [
        { name: "Synthetic Blend Oil", description: "Semi-synthetic oil upgrade", price: 20, duration: null },
        { name: "Full Synthetic Oil", description: "Premium full synthetic motor oil", price: 40, duration: null },
        { name: "High Mileage Oil", description: "Designed for high-mileage vehicles", price: 35, duration: null },
      ],
    },
    {
      name: "Scheduled Maintenance",
      description: "Factory-recommended scheduled maintenance service",
      duration: 90,
      price: 160,
      options: [
        { name: "30,000 km Service", description: "Maintenance at 30,000 km interval", price: 0, duration: null },
        { name: "60,000 km Service", description: "Maintenance at 60,000 km interval", price: 120, duration: null },
        { name: "90,000 km Service", description: "Maintenance at 90,000 km interval", price: 160, duration: null },
        { name: "120,000 km Service", description: "Maintenance at 120,000 km interval", price: 220, duration: null },
      ],
    },
    {
      name: "Seasonal Tire Changeover",
      description: "Swap between summer and winter tires",
      duration: 45,
      price: 60,
      options: [
        { name: "Tires On Rims", description: "Swap pre-mounted tires on rims", price: 0, duration: null },
        { name: "Tires Off Rims", description: "Dismount, mount, and balance tires", price: 40, duration: null },
      ],
    },
    {
      name: "Tire Rotation",
    ...
    },
    {
      ...
      price: 120,
      options: [
        { name: "Front Wheel Alignment", description: "Front-end alignment only", price: 0, duration: null },
        { name: "Four Wheel Alignment", description: "Full four-wheel alignment", price: 40, duration: null },
      ],
    },
    {
    ...
    },
    {
      ...
      price: 50,
      options: [
        { name: "Brake Pad Replacement", description: "Replace worn brake pads", price: 220, duration: null },
        { name: "Brake Pad & Rotor Replacement", description: "Replace brake pads and rotors", price: 450, duration: null },
      ],
    },
    {
    ...
    },
    {
      ...
      description: "Multi-point vehicle health check",
      duration: 45,
      price: 70,
    },
    {
      name: "Safety Inspection",
      description: "Provincial safety standards inspection",
      duration: 60,
      price: 120,
    },
    {
      ...
      price: 140,
      options: [
        { name: "Comprehensive Inspection", description: "In-depth mechanical and body inspection", price: 60, duration: null },
      ],
    },
    {
      name: "Engine & Transmission Diagnostics",
      description: "Advanced engine and transmission diagnostic scan",
      duration: 90,
      price: 130,
    },
    {
      name: "Check Engine Light / Diagnostics",
      description: "Diagnose check engine light and fault codes",
      duration: 60,
      price: 120,
      options: [
        { name: "Advanced Diagnostics", description: "In-depth diagnostic testing beyond code scan", price: 60, duration: null },
      ],
    },
    {
      name: "Air Conditioning / Heating Service",
      description: "AC and heating system inspection and repair",
      duration: 60,
      price: 120,
      options: [
        { name: "Air Conditioning Check", description: "Inspect AC system performance", price: 0, duration: null },
        { name: "AC Recharge Service", description: "Recharge refrigerant and check for leaks", price: 80, duration: null },
        { name: "Heating System Check", description: "Inspect heater core and blower", price: 20, duration: null },
      ],
    },
    {
      name: "Strange Noise / Driving Issue",
      description: "Diagnose unusual noises or driving problems",
      duration: 30,
      price: 0,
    },
    {
      name: "Not Sure What's Wrong – Inspection",
      description: "General inspection when the issue is unknown",
      duration: 30,
      price: 0,
    },
  ],
